...
{
    /*[TestFixture]
    public class QLearningAnalysisTrialRunnerTests
    {
        ...
        public void WhenInitialisingAQLearningTrial()
        {
            ...
            var trial = new QLearningAnalysisTrialRunner(_observableModel.Object,_randomNumberProvider.Object, _dataRecorder.Object);
